...
Remote mode registers the local exec-server with the agentx gateway,
then reconnects to the service-provided websocket URL and speaks plaintext
...
- remote websocket: one JSON-RPC message per websocket frame (plaintext)

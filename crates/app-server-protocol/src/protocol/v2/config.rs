...
use agentx_protocol::config_types::AutoCompactTokenLimitScope;
...
use agentx_protocol::config_types::WebSearchMode;
use agentx_protocol::config_types::WebSearchToolConfig;
...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $AGENTX_HOME/config.toml. This layer is special

...
// Deleted: ask_for_approval_granular_is_marked_experimental
// Deleted: config_granular_approval_policy_is_marked_experimental
// Deleted: config_approvals_reviewer_is_marked_experimental
// Deleted: config_requirements_granular_allowed_approval_policy_is_marked_experimental
// Deleted: client_request_thread_start_granular_approval_policy_is_marked_experimental
// Deleted: client_request_thread_resume_granular_approval_policy_is_marked_experimental
// Deleted: client_request_thread_fork_granular_approval_policy_is_marked_experimental
// Deleted: client_request_turn_start_granular_approval_policy_is_marked_experimental
    ...
    let user_item = TurnItem::UserMessage(UserMessageItem {
        ...
        content: vec![
            ...
            CoreUserInput::Skill {
                ...
                path: PathBuf::from("/repo/.agentx/skills/skill-creator/SKILL.md"),
            },
...
// Deleted: turn_start_params_round_trip_multi_agent_mode
// Deleted: thread_start_params_round_trip_multi_agent_mode
// Reason: ExperimentalApi impls return None (stubs from T8; derive macro dropped)
...
// Deleted: thread_settings_update_params_preserve_field_level_experimental_gates
// Reason: ExperimentalApi impls return None (stubs from T8; derive macro dropped)

// Deleted: turn_start_params_round_trip_environments
// Deleted: turn_start_params_preserve_empty_environments
// Reason: ExperimentalApi impls return None (stubs from T8; derive macro dropped)

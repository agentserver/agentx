...
use agentx_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use agentx_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use agentx_protocol::user_input::ByteRange as CoreByteRange;
use agentx_protocol::user_input::TextElement as CoreTextElement;

    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                agentx_protocol::protocol::AgentStatus::Errored(_)
                | agentx_protocol::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let agentx_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
mod tests {
    ...
    use agentx_protocol::protocol::CollabResumeBeginEvent;
    use agentx_protocol::protocol::CollabResumeEndEvent;
    use agentx_protocol::protocol::ExecCommandOutputDeltaEvent;
    use agentx_protocol::protocol::ExecOutputStream;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: agentx_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        assert_item_completed_server_notification(
            ...
            ItemCompletedNotification {
                ...
                item: ThreadItem::CollabAgentToolCall {
                    ...
                    agents_states: [(
                        receiver_id,
                        CollabAgentState::from(agentx_protocol::protocol::AgentStatus::NotFound),
                    )]
                    .into_iter()
                    .collect(),
                },

...
use agentx_protocol::items::parse_hook_prompt_message;
use agentx_protocol::models::MessagePhase;
use agentx_protocol::protocol::AgentReasoningEvent;
use agentx_protocol::protocol::AgentReasoningRawContentEvent;
use agentx_protocol::protocol::AgentStatus;
use agentx_protocol::protocol::ApplyPatchApprovalRequestEvent;
use agentx_protocol::protocol::CompactedItem;
use agentx_protocol::protocol::ContextCompactedEvent;
use agentx_protocol::protocol::DynamicToolCallResponseEvent;
use agentx_protocol::protocol::ErrorEvent;
use agentx_protocol::protocol::EventMsg;
use agentx_protocol::protocol::ExecCommandBeginEvent;
use agentx_protocol::protocol::ExecCommandEndEvent;
use agentx_protocol::protocol::GuardianAssessmentEvent;
use agentx_protocol::protocol::GuardianAssessmentStatus;
use agentx_protocol::protocol::ImageGenerationBeginEvent;
use agentx_protocol::protocol::ImageGenerationEndEvent;
use agentx_protocol::protocol::ItemCompletedEvent;
use agentx_protocol::protocol::ItemStartedEvent;
use agentx_protocol::protocol::McpToolCallBeginEvent;
use agentx_protocol::protocol::McpToolCallEndEvent;
use agentx_protocol::protocol::PatchApplyBeginEvent;
use agentx_protocol::protocol::PatchApplyEndEvent;
use agentx_protocol::protocol::ReviewOutputEvent;
use agentx_protocol::protocol::RolloutItem;
use agentx_protocol::protocol::ThreadRolledBackEvent;
use agentx_protocol::protocol::TurnAbortedEvent;
use agentx_protocol::protocol::TurnCompleteEvent;
use agentx_protocol::protocol::TurnStartedEvent;
use agentx_protocol::protocol::UserMessageEvent;
use agentx_protocol::protocol::ViewImageToolCallEvent;
use agentx_protocol::protocol::WebSearchBeginEvent;
use agentx_protocol::protocol::WebSearchEndEvent;
...
impl ThreadHistoryBuilder {
    ...
    fn handle_response_item(&mut self, item: &agentx_protocol::models::ResponseItem) {
        let agentx_protocol::models::ResponseItem::Message {
            role, content, id, ..
        } = item
        else {
            return;
    ...
    fn handle_item_started(&mut self, payload: &ItemStartedEvent) {
        match &payload.item {
            agentx_protocol::items::TurnItem::Plan(plan) => {
            ...
            agentx_protocol::items::TurnItem::Sleep(_) => {
                self.upsert_item_in_turn_id(
                    &payload.turn_id,
                    ThreadItem::from(payload.item.clone()),
                );
            }
            agentx_protocol::items::TurnItem::UserMessage(_)
            | agentx_protocol::items::TurnItem::HookPrompt(_)
            | agentx_protocol::items::TurnItem::AgentMessage(_)
            | agentx_protocol::items::TurnItem::Reasoning(_)
            | agentx_protocol::items::TurnItem::WebSearch(_)
            | agentx_protocol::items::TurnItem::ImageView(_)
            | agentx_protocol::items::TurnItem::ImageGeneration(_)
            | agentx_protocol::items::TurnItem::FileChange(_)
            | agentx_protocol::items::TurnItem::McpToolCall(_)
            | agentx_protocol::items::TurnItem::ContextCompaction(_) => {}
        }
    }
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &agentx_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &agentx_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &agentx_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &agentx_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &agentx_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_sub_agent_activity(
        &mut self,
        payload: &agentx_protocol::protocol::SubAgentActivityEvent,
    ) {
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &agentx_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &agentx_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &agentx_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &agentx_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &agentx_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(&mut self, payload: &agentx_protocol::protocol::ReviewRequest) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &agentx_protocol::protocol::ExitedReviewModeEvent,
    ) {
        let review = payload
            .review_output
            .as_ref()
...
fn convert_dynamic_tool_content_items(
    items: &[agentx_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
...
mod tests {
    ...
    use agentx_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use agentx_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use agentx_protocol::items::SleepItem as CoreSleepItem;
    use agentx_protocol::items::TurnItem as CoreTurnItem;
    use agentx_protocol::items::UserMessageItem as CoreUserMessageItem;
    use agentx_protocol::items::build_hook_prompt_message;
    use agentx_protocol::mcp::CallToolResult;
    use agentx_protocol::models::ImageDetail;
    use agentx_protocol::models::MessagePhase as CoreMessagePhase;
    use agentx_protocol::models::WebSearchAction as CoreWebSearchAction;
    use agentx_protocol::parse_command::ParsedCommand;
    use agentx_protocol::protocol::AgentMessageEvent;
    use agentx_protocol::protocol::AgentReasoningEvent;
    use agentx_protocol::protocol::AgentReasoningRawContentEvent;
    use agentx_protocol::protocol::ApplyPatchApprovalRequestEvent;
    use agentx_protocol::protocol::CodexErrorInfo;
    use agentx_protocol::protocol::CompactedItem;
    use agentx_protocol::protocol::DynamicToolCallResponseEvent;
    use agentx_protocol::protocol::ExecCommandEndEvent;
    use agentx_protocol::protocol::ExecCommandSource;
    use agentx_protocol::protocol::ItemStartedEvent;
    use agentx_protocol::protocol::McpInvocation;
    use agentx_protocol::protocol::McpToolCallEndEvent;
    use agentx_protocol::protocol::PatchApplyBeginEvent;
    use agentx_protocol::protocol::ThreadRolledBackEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![agentx_protocol::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                agentx_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
    ...
    fn reconstructs_declined_guardian_command_item() {
        let events = vec![
            ...
            EventMsg::GuardianAssessment(GuardianAssessmentEvent {
                ...
                risk_level: Some(agentx_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(agentx_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("Would delete user data.".into()),
                decision_source: Some(
                    agentx_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: serde_json::from_value(serde_json::json!({
                    "type": "command",
                    "source": "shell",
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(agentx_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(agentx_protocol::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: agentx_protocol::openai_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(agentx_protocol::openai_models::ReasoningEffort::Medium),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                agentx_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                agentx_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(agentx_protocol::models::ResponseItem::Message {
                id: Some("msg-1".into()),
                role: "user".into(),
                content: vec![agentx_protocol::models::ContentItem::InputText {

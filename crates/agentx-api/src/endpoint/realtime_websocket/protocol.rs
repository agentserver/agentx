...
pub use agentx_protocol::protocol::RealtimeAudioFrame;
pub use agentx_protocol::protocol::RealtimeEvent;
pub use agentx_protocol::protocol::RealtimeOutputModality;
pub use agentx_protocol::protocol::RealtimeTranscriptEntry;
pub use agentx_protocol::protocol::RealtimeVoice;
use serde::Serialize;

...
const MISSING_BWRAP_WARNING: &str = concat!(
    "agentx could not find bubblewrap on PATH. ",
    "Install bubblewrap with your OS package manager. ",
    "agentx will use the bundled bubblewrap in the meantime.",
);
const USER_NAMESPACE_WARNING: &str =
    "agentx's Linux sandbox uses bubblewrap and needs access to create user namespaces.";
pub(crate) const WSL1_BWRAP_WARNING: &str = concat!(
    "agentx's Linux sandbox uses bubblewrap, which is not supported on WSL1 ",

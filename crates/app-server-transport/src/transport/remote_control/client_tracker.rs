...
fn remote_control_message_starts_connection(message: &JSONRPCMessage) -> bool {
    matches!(
        message,
        JSONRPCMessage::Request(agentx_app_server_protocol::JSONRPCRequest { method, .. })
...
mod tests {
    ...
    fn initialized_notification() -> JSONRPCMessage {
        JSONRPCMessage::Notification(agentx_app_server_protocol::JSONRPCNotification {
            ...
            .handle_message(ClientEnvelope {
                event: ClientEvent::ClientMessage {
                    message: JSONRPCMessage::Notification(
                        agentx_app_server_protocol::JSONRPCNotification {
                            method: "initialized".to_string(),
                            params: None,
                        },
                    ),
